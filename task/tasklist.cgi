...
$projects{PROJECTIDLABEL}[0]=$c{general}{label}{projectid};
 ...
 print $q->header;
 if($mode eq "list") {
 	$templatefile=&getTemplateFile($c{dir}{tasktemplates},"tasklist.tmpl");
 }
 elsif($mode eq "new") {
 	$templatefile=&getTemplateFile($c{dir}{tasktemplates},"newtask.tmpl");
 }
$projects{HEADER}[0]=  &getHeader($userid, "task");
$projects{FOOTER}[0]=  &getFooter($userid, "task");
